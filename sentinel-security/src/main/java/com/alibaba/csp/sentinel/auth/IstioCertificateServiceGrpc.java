package com.alibaba.csp.sentinel.auth;
...
public final class IstioCertificateServiceGrpc {
    ...
    private static volatile io.grpc.MethodDescriptor<IstioCertificateRequest, IstioCertificateResponse> getCreateCertificateMethod;
    ...
    public static io.grpc.MethodDescriptor<IstioCertificateRequest, IstioCertificateResponse> getCreateCertificateMethod() {
        ...
        if ((getCreateCertificateMethod = IstioCertificateServiceGrpc.getCreateCertificateMethod) == null) {
            synchronized (IstioCertificateServiceGrpc.class) {
                if ((getCreateCertificateMethod = IstioCertificateServiceGrpc.getCreateCertificateMethod) == null) {
                    IstioCertificateServiceGrpc.getCreateCertificateMethod = getCreateCertificateMethod = io.grpc.MethodDescriptor.<IstioCertificateRequest, IstioCertificateResponse>newBuilder()
    ...
    public static IstioCertificateServiceStub newStub(io.grpc.Channel channel) {
        io.grpc.stub.AbstractStub.StubFactory<IstioCertificateServiceStub> factory = new io.grpc.stub.AbstractStub.StubFactory<IstioCertificateServiceStub>() {
            @Override
    ...
    public static IstioCertificateServiceBlockingStub newBlockingStub(
        ...
        io.grpc.stub.AbstractStub.StubFactory<IstioCertificateServiceBlockingStub> factory = new io.grpc.stub.AbstractStub.StubFactory<IstioCertificateServiceBlockingStub>() {
            @Override
    ...
    public static IstioCertificateServiceFutureStub newFutureStub(
            io.grpc.Channel channel) {
        io.grpc.stub.AbstractStub.StubFactory<IstioCertificateServiceFutureStub> factory = new io.grpc.stub.AbstractStub.StubFactory<IstioCertificateServiceFutureStub>() {
            @Override
